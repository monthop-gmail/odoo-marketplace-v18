...
class ResConfigSettings(models.TransientModel):
    ...
    mp_min_withdrawal_amount = fields.Integer(string="Minimum Withdrawal Amount", default=1000)
    mp_withdrawal_cooldown_days = fields.Integer(
        string="Withdrawal Cooldown (Days)", default=0,
        help="Minimum days between withdrawal requests. 0 = no cooldown.")
    group_mp_product_variant = fields.Boolean(
        ...
        group='core_marketplace.marketplace_seller_group',
        implied_group='product.group_product_variant'
    )
    group_mp_shop_allow = fields.Boolean(
        string="Allow sellers to manage seller shop.",
        group='core_marketplace.marketplace_seller_group',
        implied_group='core_marketplace.group_marketplace_seller_shop'
    )
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('core_marketplace.mp_min_withdrawal_amount', self.mp_min_withdrawal_amount)
        self.env['ir.config_parameter'].sudo().set_param('core_marketplace.mp_withdrawal_cooldown_days', self.mp_withdrawal_cooldown_days)
    ...
    def get_values(self):
        ...
        mp_min_withdrawal_amount = int(self.env['ir.config_parameter'].sudo().get_param('core_marketplace.mp_min_withdrawal_amount', '1000'))
        mp_withdrawal_cooldown_days = int(self.env['ir.config_parameter'].sudo().get_param('core_marketplace.mp_withdrawal_cooldown_days', '0'))
        ...
        res.update(
            ...
            mp_min_withdrawal_amount = mp_min_withdrawal_amount,
            mp_withdrawal_cooldown_days = mp_withdrawal_cooldown_days,
