...
class MarketplaceStock(models.Model):
    ...
    # Odoo 18: _read_group_fill_results removed - use fold attribute in selection field instead
    # @api.model
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        ...
        seller_group = self.env['ir.model.data']._xmlid_to_res_id(
            'core_marketplace.marketplace_seller_group')
        officer_group = self.env['ir.model.data']._xmlid_to_res_id(
    ...
    def change_product_qty(self):
        ...
        for template_obj in self:
            if not self.env.user.has_group('stock.group_stock_manager'):  # Odoo 18: user_has_groups -> env.user.has_group
