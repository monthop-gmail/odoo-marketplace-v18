        ...
        try:
            for r in res:
                ...
                if mp_dynamic_domain and SELLER_DOMAIN_STRING in mp_dynamic_domain:
                    ...
                    updated_domain = ""
                    if obj_user.has_group('core_marketplace.marketplace_officer_group'):
                        ...
                        for index in list_of_index:
                            ...
                            if var == "id":
                                r["view_mode"] = "form"
                                r["res_id"] = seller_id
                                r["views"] = [(self.env.ref('core_marketplace.wk_seller_form_view').id, "form")]
...
class IrHttp(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        return modules + ['core_marketplace']
