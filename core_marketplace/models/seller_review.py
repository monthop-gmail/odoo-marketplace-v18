...
class SellerReview(models.Model):
    ...
    state = fields.Selection([('pub', 'Published'), ('unpub', 'Unpublished')],
                             compute='_get_value_website_published', store=True, copy=False)  # Odoo 18: removed translate=True
...
class SellerRecommendation(models.Model):
    ...
    recommend_state = fields.Selection(
        [('yes', 'YES'), ('no', 'NO')], string="Recommend", default="no")  # Odoo 18: removed translate=True from Selection
    seller_id = fields.Many2one(
        "res.partner", string="Recommended Seller", required=True, domain=[('seller', '=', True)])
    state = fields.Selection(
        [('pub', 'Published'), ('unpub', 'Unpublished')], default="unpub")  # Odoo 18: removed translate=True from Selection
