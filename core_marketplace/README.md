...
Module Updated from version 1.2.0 to 2.0.0
-------------------------------------------
Changes:

01. Modify marketplace dashboard kanban view (Seller, Product, Order, Stock, Seller Payment).
02. Update Seller profile kanban view.
03. Update Seller payment kanban view.
04. Update UI in seller profile form view.
05. Update seller list template.
06. Update seller profile template.
07. Update seller reviews section.
08. Update seller recommendation section.
09. Update seller rating form.
