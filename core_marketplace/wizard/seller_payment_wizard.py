...
class SellerPaymentWizard(models.TransientModel):
        ...
        if seller_id and seller_id.payment_method:
            ...
            try:
                payment_method_cheque_id = self.env['ir.model.data']._xmlid_to_res_id(
                    'core_marketplace.marketplace_seller_payment_method_data1')
                if payment_method_cheque_id:
                    payment_method = payment_method_cheque_id
    ...
    def do_request(self):
        ...
        return self.env["mp.wizard.message"].generated_message(msg, _("Warning"))
