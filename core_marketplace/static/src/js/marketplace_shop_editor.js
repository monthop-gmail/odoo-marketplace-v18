...
// Helper function to call ORM methods via RPC
...
// Check if website_sale options exist before extending
if (options.registry.website_sale) {
    options.registry.website_sale.include({
        start: function () {
            var self = this;
            ...
            {
                ormCall('seller.shop.style', 'search_read', [[]])
                    .then(function (data) {
