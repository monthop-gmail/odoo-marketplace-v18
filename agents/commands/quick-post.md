...
- Uses [commerce](../skills/commerce/SKILL.md) for product creation
- Uses [liff-frontend](../skills/liff-frontend/SKILL.md) for UI implementation
- Uses [seller-engine](../skills/seller-engine/SKILL.md) for staff permission model
